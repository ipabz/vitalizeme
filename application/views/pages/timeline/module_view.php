    ...
    <div class="tc_right">
        ...
        <div class="article <?php print (($month <= 6 && $counter == 1) ? 'now' : (($counter == 1) ? 'now2' : '')); ?> <!--current_step-->">
            ...
            <div class="topics">
				...
				?>
                <div class="topic"><a class="thelink" href="<?php print site_url('timeline/view_topic/'.$topic['topic_id']); ?>"><?php print $topic['topic']; ?></a> <a href="<?php print site_url('timeline/track/'.$topic['topic_id']); ?>" class="star glyphicon glyphicon-star<?php print $this->timeline_model->topic_done($topic['topic_id']); ?>"></a></div>
                <?php	
				}
				?>
            </div>
